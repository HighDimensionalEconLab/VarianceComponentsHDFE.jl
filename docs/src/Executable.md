...
1. Download our latest version of the package from the following [link](https://github.com/HighDimensionalEconLab/VarianceComponentsHDFE.jl/releases/download/v0.1.7.6/vchdfe--windows-latest.tar.gz). Move this file to `desired_installation_path`.
...
1. Download our latest version of the package from the following [link](https://github.com/HighDimensionalEconLab/VarianceComponentsHDFE.jl/releases/download/v0.1.7.6/vchdfe-v0.1.7.6-macos-latest.tar.gz). Move this file to the desired installation path.
